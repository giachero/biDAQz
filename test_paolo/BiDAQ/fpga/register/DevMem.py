...
class DevMemBuffer:
    ...
    def hexdump(self, word_size=4, words_per_row=4):
        ...
        # This is more efficient then concatenating immutable strings.
        ...
        while word < len(d):
            ...
            while word < max_col:
                ...
                if word_size == 4:
                    dump.append("0x{0:08X} ".format(d[word]))
                    word += 1
                    continue
                ...
                if word_size == 2:
                    ...
                    dump.append("0x{0:04X}".format(dh[0]))
                    word += 1
                elif word_size == 1:
                    db = struct.unpack('BBBB', packed)
                    dump.append("0x{0:02X}".format(db[0]))
                    word += 1
